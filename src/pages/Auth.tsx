      ...
      >
        <div className="glass-strong rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground mb-1">Acesso do Aluno</h1>
            <p className="text-sm text-muted-foreground">Insira seus dados para acessar o painel.</p>
          </div>
